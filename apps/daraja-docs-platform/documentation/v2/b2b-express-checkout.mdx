...
<Image src="/customer-journey.png" alt="Customer Journey Flow" />

### Low-Level Architecture

<Image src="/b2b-arch.png" alt="B2B USSD Push to Till Architecture" />
...
<Image src="/merchant-operator-id.png" alt="Merchant operator ID" />

### Step 2: PIN Entry

Next step, they are prompted to enter their operator PIN.

<Image src="/pin-entry-screen.png" alt="PIN Entry Screen" />

### Step 3: Payment Confirmation

Vendor Prompted to accept the amount.

<Image src="/payment-confirmation.png" alt="Payment Confirmation" />

### Step 4: Success Acknowledgment

The merchant gets an acknowledgment they'll receive a text once done.

<Image src="/success-acknowledgment.png" alt="Success Acknowledgment" />
...
<Image src="/mpesa-web-portal-operators.png" alt="Mpesa Web Portal Operators" />  
...
<Image src="/organization-details-config.png" alt="Mpesa Web Portal Operators" />
