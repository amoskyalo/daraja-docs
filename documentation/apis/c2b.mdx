...
<Link method="POST" href="https://sandbox.safaricom.co.ke/mpesa/c2b/v1/registerurl" />
...
<img src="/flowchart.png" alt="C2B Process Flowchart" style={{ width: '75%', height: 'auto', borderRadius: '8px' }} />
