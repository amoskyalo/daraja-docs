...
<Playground 
    ...
    requestParameters={[
        { name: 'Initiator', type: 'text', label: 'Initiator', bodyKey: 'Initiator', value: 'testapi' },
        { name: 'SecurityCredential', type: 'text', label: 'SecurityCredential', bodyKey: 'SecurityCredential', value: 'IAJVUHDGJ6yDU3aop/WI9oSPhkW3DV1h7EAt3iRyymTZh1jpzCNnI/xFKZNoOOF8PUFgjmEOih...' },
        { name: 'CommandID', type: 'text', label: 'CommandID', bodyKey: 'CommandID', value: 'BusinessPayToBulk' },
        ...
        { name: 'PartyA', type: 'text', label: 'PartyA', bodyKey: 'PartyA', value: '600979' },
        { name: 'PartyB', type: 'text', label: 'PartyB', bodyKey: 'PartyB', value: '600000' },
        { name: 'AccountReference', type: 'text', label: 'AccountReference', bodyKey: 'AccountReference', value: '353353' },
        { name: 'Requester', type: 'text', label: 'Requester', bodyKey: 'Requester', value: '254708374149' },
        { name: 'Remarks', type: 'text', label: 'Remarks', bodyKey: 'Remarks', value: 'OK' },
        { name: 'QueueTimeOutURL', type: 'text', label: 'QueueTimeOutURL', bodyKey: 'QueueTimeOutURL', value: 'https://mydomain/path/timeout' },
        { name: 'ResultURL', type: 'text', label: 'ResultURL', bodyKey: 'ResultURL', value: 'https://mydomain/path/result' },
    ]}
>
...
{
  "Initiator": "testapi",
  "SecurityCredential": "IAJVUHDGJ6yDU3aop/WI9oSPhkW3DV1h7EAt3iRyymTZh1jpzCNnI/xFKZNoOOF8PUFgjmEOih...",
...
| `Initiator`              | The M-Pesa API operator username. This user needs Org Business Pay to Bulk API initiator role on M-Pesa                                                                                                        | String | `Username`, `user_name`                                                                     |
...
```json
{
  ...
  "ConversationID": "AG_20230420_26d50420_20107599fd5662ef6dd054",
  "ResponseCode": "0",
...
| Name                       | Description                                                                      | Type   | Sample Values                              |
| -------------------------- | -------------------------------------------------------------------------------- | ------ | ------------------------------------------ |
| `OriginatorConversationID` | Unique request identifier assigned by Daraja upon successful request submission. | String | `String of less then 20 characters`        |
| `ConversationID`           | Unique request identifier assigned by M-Pesa upon successful request submission. | String | `AG_123456778909B3`                        |
    ...
    "ResultParameters": {
      "ResultParameter": [
        ...
        },
        {
          ...
          "Value": "{Amount={CurrencyCode=KES, MinimumAmount=59949000, BasicAmount=599490.00}}"
        }
      ]
    },
    "ReferenceData": {
...
| `OriginatorConversationId`         | Unique request identifier assigned by API gateway upon successful request submission.                                                                                    | String      | `AG_2376487236_1267232989KIJHKH`                                                               |
...
| `DebitPartyAffectedAccountBalance` | The balance in the organization's account from which funds were deducted under the shortcode. Returned as one of the key-value objects under the ResultParameter array.  | String      | `Working Account                                                                               |
...
```json
{
  "Result": {
    ...
    "OriginatorConversationID": "12337-235089183-5",
    "ConversationID": "AG_20200120_000065726505fa9ae5c0",
...
| `OriginatorConversationId` | This is a global unique identifier for the transaction request returned by the API proxy upon successful request submission.                                                   | String      | `AG_2376487236_1267232989KIJHKH`                                                               |
